...
?>
    <a name="about"></a>
    <div class="">
        <h2>O treningu Weidera</h2>
        <!--<p>Weider six (A6W) is an ABS traing. If you want to have a flat stomach or a 6 pack this is the workout for you!!</p>


        <p>Each training session consists of 6 exercises each of which is repeated the number of times assigned for the day
            ...
            However, every few days the number of repetitions in each set will increase, therefore making it more challenging for you and your muscles.</p>

        <h3>Weider Six - exercise 1</h3>
        <p>Lay down on your back with your hands flat on the ground along your body.
            ...
            Swap your legs and repeat.</p>

        <h3>Weider Six - exercise 2</h3>
        <p>Lay down on your back with your hands flat on the ground along your body.
